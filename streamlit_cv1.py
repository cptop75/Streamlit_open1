...
image = Image.open('C:/Users/kwater/PycharmProjects/pythonProject/Study/Streamlit/image/distance.PNG')
...
image = Image.open('C:/Users/kwater/PycharmProjects/pythonProject/Study/Streamlit/image/ex1.png')
st.image(image, caption='이론')

st.write("")
"A lightweight vision library for performing large scale object detection & instance segmentation"

file_ = open("C:/Users/kwater/PycharmProjects/pythonProject/Study/Streamlit/image/sahi.gif", "rb")
contents = file_.read()
...
image1 = Image.open('C:/Users/kwater/PycharmProjects/pythonProject/Study/Streamlit/image/local.png')
st.image(image1, caption='위치')

st.write("")
st.markdown("### CV Algorithm Comparison")
image_comparison(
    img1="C:/Users/kwater/PycharmProjects/pythonProject/Study/Streamlit/image/2-1.png",
    img2="C:/Users/kwater/PycharmProjects/pythonProject/Study/Streamlit/image/2-2.png",
    label1="Yolov7",
    label2="SAHI + Yolov5",
    width=1080,
)